      ...
      <div class="form-section">
        ...
        <?php if(!empty($showOtpForm)): ?>
          ...
          <form method="POST" autocomplete="off">
            ...
            <button type="submit" name="verify_otp" class="primary-button">
              Verify OTP
            </button>
          </form>
        <?php else: ?>
          ...
          <form method="POST" autocomplete="on">
            ...
            <div class="form-group checkbox">
              <input
                ...
                id="remember-me"
                name="remember_me"
                <?php if(!empty($_COOKIE['email'])) echo 'checked'; ?>
              />
            ...
            <div class="social-buttons">
              <button type="button" class="social-button" onclick="location.href='google-auth.html'">
                <img src="https://api.iconify.design/flat-color-icons:google.svg" alt="Google" />
                Sign in with Google
              </button>
              <button type="button" class="social-button" onclick="location.href='apple-auth.html'">
